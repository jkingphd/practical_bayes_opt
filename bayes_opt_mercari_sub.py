...
if __name__ == '__main__':
    X_train = load_dill('mercari.dill')['X_train'][:10000]
    y_train = load_dill('mercari.dill')['y_train'][:10000]
    ...
    dump_dill('rs_mercari_sub.dill', rs)
    ...
    dump_dill('mercari_result_sub.dill', {'gs':gs, 'gs_time':gs_time, 'bo':bo, 'bo_time':bo_time})